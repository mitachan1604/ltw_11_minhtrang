                ...
                <table class="tbl-calc">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input class="input-calc" type="text" name="kq_dien_tich" id="kq_dien_tich" disabled value="<?php
                                ...
                                function calculate_area($so_a, $so_b) {
                                    return $so_a * $so_b;
                                }

                                if (isset($_POST['dien_tich']) ) {
                                    if (empty($so_a) || empty($so_b)) {
                                        $error = 'Vui lòng nhập dữ liệu hợp lệ';
                                    } elseif (!is_number($so_a) || !is_number($so_b)) {
                                        $error = 'Vui lòng nhập giá trị số hợp lệ';
                                    } else {
                                        $area = calculate_area($so_a, $so_b);
                                        $error = '';
                                        echo "" . $area;
                                    }
                                }
                        ...
                        <tr>
                            <td></td>
                            <td><input class="input-calc"  style="border: 1px solid yellow" type="text" name="msg" id="msg" disabled value="<?php echo $error ?>"></td>
                        </tr>
                    </tbody>
                </table>
            </form>
